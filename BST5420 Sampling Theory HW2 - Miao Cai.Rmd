...
\widehat{V(\hat{B})} & = (1 - \frac{n}{N})\frac{S_e^2}{n\bar{x}^2}
\end{align*}
...
```{r fig.cap='Boxplots of the total number of candy Green Globules sold in each sample city'}
...
N = 45
n = nrow(sum_tab)
mu_hat = N/n*sum(M_i*sum_tab$Mean)/M
```
